...
* **Let op:** Een Erase Flash wist ook je Node Identiteit! Maak vooraf een back-up van je `private key` als je je huidige identiteit in het mesh-netwerk wilt behouden. Flash je companion na een  "Erase Flash" altijd met de `firmware-merged.bin`.
...
Je app is nu via je lokale netwerk gekoppeld aan de companion en klaar voor gebruik!
