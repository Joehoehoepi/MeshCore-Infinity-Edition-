...
void HeltecV4Board::begin() {
  ...
  const char* HeltecV4Board::getManufacturerName() const {
    ...
    return loRaFEMControl.getFEMType() == KCT8103L_PA ? "Heltec V4.3 TFT - Infinity" : "Heltec V4 TFT - Infinity";
#else
    return loRaFEMControl.getFEMType() == KCT8103L_PA ? "Heltec V4.3 OLED - Infinity" : "Heltec V4 OLED - Infinity";
#endif
  }